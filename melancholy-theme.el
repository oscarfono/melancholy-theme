...
(let ((font-heading "Raleway-Regular")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face ((t (:family ,font-default-italic :foreground ,my-visited ))))
   ...
   `(font-lock-string-face ((t (:family ,font-default-italic :foreground ,my-visited :weight extra-light :slant italic))))
   ...
   ;; Flycheck
   ;; ========================================
   `(flycheck-error ((t (:foreground ,my-active :underline (:style wave)))))
